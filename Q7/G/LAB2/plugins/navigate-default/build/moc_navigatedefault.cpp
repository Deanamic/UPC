...
struct qt_meta_stringdata_NavigateDefault_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NavigateDefault_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NavigateDefault_t qt_meta_stringdata_NavigateDefault = {
    {
QT_MOC_LITERAL(0, 0, 15) // "NavigateDefault"
...
QT_INIT_METAOBJECT const QMetaObject NavigateDefault::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NavigateDefault.data,
      qt_meta_data_NavigateDefault,  qt_static_metacall, nullptr, nullptr}
};
...
void *NavigateDefault::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NavigateDefault.stringdata0))
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    'a',  's',  's',  'N',  'a',  'm',  'e',  0x00,
    0x0f, 0x00, 'N',  'a',  'v',  'i',  'g',  'a', 
    't',  'e',  'D',  'e',  'f',  'a',  'u',  'l', 
    't',  0x00, 0x00, 0x00, 'Z',  '`',  0xa1, 0x00,
