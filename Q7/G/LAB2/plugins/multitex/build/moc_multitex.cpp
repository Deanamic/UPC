...
struct qt_meta_stringdata_Multitex_t {
    QByteArrayData data[1];
    char stringdata0[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Multitex_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Multitex_t qt_meta_stringdata_Multitex = {
    {
QT_MOC_LITERAL(0, 0, 8) // "Multitex"
...
QT_INIT_METAOBJECT const QMetaObject Multitex::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Multitex.data,
      qt_meta_data_Multitex,  qt_static_metacall, nullptr, nullptr}
};
...
void *Multitex::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Multitex.stringdata0))
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    'a',  's',  's',  'N',  'a',  'm',  'e',  0x00,
    0x08, 0x00, 'M',  'u',  'l',  't',  'i',  't', 
    'e',  'x',  0x00, 0x00, 'Z',  '`',  0xa1, 0x00,
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    'a',  'm',  'e',  0x00, 0x08, 0x00, 'M',  'u', 
    'l',  't',  'i',  't',  'e',  'x',  0x00, 0x00,
...
QT_MOC_EXPORT_PLUGIN(Multitex, Multitex)
