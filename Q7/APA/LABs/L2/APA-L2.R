...
# We measure clustering quality by the Calinski-Harabasz index (recommended for Gaussian-based clustering methods). This index measures the dispersion of the data points within the clusters (SSW) and between the clusters (SSB)
# A good clustering has small SSW (compact clusters) and large SSB (separated cluster centers)
# There is also a correction factor for the number of clusters
...
## So, is this a reasonable result if we ask for 2?
...
## "general" for the general family, 
## "diagonal" for the diagonal family, 
## "spherical" for the spherical family 
## and "all" for all families (meaning the union)
## 
...
## The method works also very smoothly; why? because we data *is* Gaussian
